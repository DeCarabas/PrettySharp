...
// Nest the given document by 'i' spaces.
...
// A group of documents: either on one line or on multiple lines. This is the
// core line-breaking thing; if you have something that might be together on
// one line then use `group`.
let rec group x = 
