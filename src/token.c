...
enum TokenType keyword_type(const char *start, int len) {
  ...
  case 'b':
    if (len > 1) {
      ...
      case 'y':
        if (len > 2) {
          return check_kw(start, len, 2, 2, "te", TOKEN_KW_BYTE);
        } else {
          return TOKEN_KW_BY;
        }
        break;
    ...
    if (len > 1) {
      ...
      case 'o':
        if (len > 2) {
          switch (start[2]) {
          case 'u':
            return check_kw(start, len, 3, 4, "ble", TOKEN_KW_DOUBLE);
          }
        } else {
          return TOKEN_KW_DO;
        }
  ...
  case 'f':
    if (len > 1) {
      ...
      case 'i':
        ...
        break;
      case 'l':
        return check_kw(start, len, 2, 4, "oat", TOKEN_KW_FLOAT);
      case 'o':
        if (len > 2) {
          switch (start[2]) {
          case 'r':
            if (len > 3) {
              return check_kw(start, len, 3, 4, "each", TOKEN_KW_FOREACH);
            } else {
              return TOKEN_KW_FOR;
            }
            break;
  ...
  case 'w':
    if (len > 1 && start[1] == 'h') {
      if (len > 2 && start[2] == 'e') {
        ...
        return check_kw(start, len, 2, 3, "ile", TOKEN_KW_WHILE);
      }
    }
    break;
